...
namespace KBEngine
{
	...
	public abstract class AccountBase : Entity
	{
		...
		public abstract void onRegisterSpawnPoint(Vector3 arg1); 
		public abstract void onReqSpaceReport(List<SPACE_REPORT> arg1); 
		...
		public override void onRemoteMethodCall(MemoryStream stream)
		{
			...
			switch(method.methodUtype)
			{
				case 10005:
					...
					break;
				case 3:
					Vector3 onRegisterSpawnPoint_arg1 = stream.readVector3();
					onRegisterSpawnPoint(onRegisterSpawnPoint_arg1);
					break;
				case 2:
					List<SPACE_REPORT> onReqSpaceReport_arg1 = ((DATATYPE_AnonymousArray_34)method.args[0]).createFromStreamEx(stream);
					onReqSpaceReport(onReqSpaceReport_arg1);
					break;
				default:
					break;
			};
